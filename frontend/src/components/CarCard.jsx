      ...
      <div style={{ padding: "0.9rem 1rem 1rem", textAlign: "left" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between",
          ...
          <div style={{ textAlign: "right", flexShrink: 0, whiteSpace: "nowrap" }}>
            <span style={{ fontSize: "1.1rem", fontWeight: 800, color: "var(--ocean)" }}>{fmtPeso(car.price)}</span>
            <span style={{ fontSize: "0.78rem", fontWeight: 500, color: "var(--muted)" }}>/day</span>
          </div>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.3rem",
          ...
          <i className="fa-solid fa-location-dot" style={{ color: "var(--ocean)", fontSize: "0.72rem" }}/>
          {car.location}
        </div>
